...
-- Started on 2015-08-21 20:15:06 WIB
...
COPY "hai-area" (id, name, attrib, coord, "createID", "createDate", "updID", "updDate", del) FROM stdin;
\.
...
-- Completed on 2015-08-21 20:15:06 WIB
